...
<body class="host_version">
	...
	<div class="container">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">Patient Login</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/patient-login.png">
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-info">
					...
					%>
						<form action="PatientLogin" method="post">
							...
							<a class="for-pwd" href="patient-register.jsp">New Patient Register</a><a class="for-pwd" href="patient-forgot-password.jsp">Forgot your password?</a>
						</form>
					</div>
				</div>
			</div>
